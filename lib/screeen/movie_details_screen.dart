...
import '../widgets/actor_card_info.dart';
              ...
              children: [
                Container(
                  ...
                  child: Stack(
                    children: [
                      FutureBuilder(
                        future: apiPopular.getIdVideo(widget.popularModel.id!),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 10),
                      Text(
                        widget.popularModel.voteAverage!.toString(),
                        style: TextStyle(
                          color: Colors.yellow,
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text(
                      widget.popularModel.voteAverage!.toString() + '/100',
                      style: TextStyle(
                        color: Colors.yellow.shade200,
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
